...
Idea sigmy
\begin{enumerate}
    \item použijeme UTS na simulaciu <M> na <w>. Ak UTS cyklí, potom jazyk Affine je prázdny (a
        <M>#<w> nepatrí do MP. Ak
        zastaví, tak prijimeme ak reťazec <y> patrí do Affine. POZOR: Affine musi nutne vzdy
        obsahovat aspon jeden retazec.
\end{enumerate}
